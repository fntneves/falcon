...
function Shiviz() {
    ...
    /* Hide elements related with examples and regexes */
    $("#examples").hide();
    $("#parser").hide();
    $("#delimiter").hide();
    $("#log_regex_label").hide();
 ...
 */
Shiviz.prototype.visualize = function(log, /* regexpString, delimiterString, */ sortType, descending, fileName) {
    try {
