...
class EventFactory:
    ...
    def _create_socket_event(data, event_type):
        if event_type == EventType.SOCKET_CONNECT:
            ...
            return SocketAccept(data.pid, data.tgid, data.comm, data.socket.sport, data.socket.dport, data.socket.saddr, data.socket.daddr, data.socket.family)
            ...
            return SocketReceive(data.pid, data.tgid, data.comm, data.socket.sport, data.socket.dport, data.socket.saddr, data.socket.daddr, data.socket.family, data.extra.bytes)
