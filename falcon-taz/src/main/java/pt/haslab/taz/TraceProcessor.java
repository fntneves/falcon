...
public enum TraceProcessor {
    ...
    public void loadEventTrace(String pathToFile) throws JSONException, IOException{
    ...
    private void handleSndSocketEvent(SocketEvent snd) {
        MyPair<Deque<SocketEvent>, Deque<SocketEvent>> eventPairs = getOrCreatePartialEventsPairs(snd.getDirectedSocket());
    ...
    private void handleRcvSocketEvent(SocketEvent rcv) {
        MyPair<Deque<SocketEvent>, Deque<SocketEvent>> eventPairs = getOrCreatePartialEventsPairs(rcv.getDirectedSocket());
        Deque<SocketEvent> sndEvents = eventPairs.getFirst();
        Deque<SocketEvent> rcvEvents = eventPairs.getSecond();
